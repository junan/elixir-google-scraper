defmodule ElixirGoogleScraper.Accounts.UserToken do
  ...
  def build_session_token(user) do
    ...
    {token, %ElixirGoogleScraper.Accounts.UserToken{token: token, context: "session", user_id: user.id}}
  end
  ...
  def user_and_contexts_query(user, [_ | _] = contexts) do
    from t in ElixirGoogleScraper.Accounts.UserToken, where: t.user_id == ^user.id and t.context in ^contexts
  end
end
